...
<Tabs>
  ...
  <TabItem value="new-teamspeak" label="All New TeamSpeak (Ts5)">
    Connect to your TeamSpeak server and right click the server name in the top center of your TeamSpeak client and then select "Use Privilege Key" in the drop-down menu.
  </TabItem>
</Tabs>
...
> To control your TeamSpeak server log back into your server via [SSH (PuTTY)](./putty), switch to the [teamspeak user](#switch-to-teamspeak-user), go to the teamspeak directory and execute the commands below
